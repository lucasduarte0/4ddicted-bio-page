  ...
  socialMedia: [
    {
      ...
      url: "https://wa.me/5537999414303",
      icon: "fa-whatsapp",
    },
    {
      name: "Instagram",
      url: "https://instagram.com/4ddclub",
      icon: "fa-instagram",
    },
  ],
};

const colors = ["#4BE066", "#cd486b", "#81B29A", "#F2CC8F"];
...
function Button(props) {
  ...
  return (
    <a
      href={props.url}
      className="button w-[90%] mx-auto font-semibold text-white"
      style={style}
    >
      {props.name}
      <i
        class={`fa-brands ${props.icon} fa-xl my-2 ml-2 text-[${props.colors}]`}
      ></i>
    </a>
  );
}
    ...
    <section className="profile c">
      <div className="m-auto w-full sm:w-[300px] px-10">
        ...
        <div>
          ...
          <div className="profile-bio text-white font-light text-base">
